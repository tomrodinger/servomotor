...
COMMANDS_H_BASENAME = "Commands.h"
SERVOMOTOR_CPP_BASENAME = "Servomotor.cpp"
SERVOMOTOR_H_BASENAME = "Servomotor.h"

# Output file paths
COMMANDS_H_FILE = os.path.join(ARDUINO_LIB_DIR, COMMANDS_H_BASENAME)
SERVOMOTOR_CPP_FILE = os.path.join(ARDUINO_LIB_DIR, SERVOMOTOR_CPP_BASENAME)
SERVOMOTOR_H_FILE = os.path.join(ARDUINO_LIB_DIR, SERVOMOTOR_H_BASENAME)
...
def generate_servo_motor_files(json_file, data_types_file, header_file, source_file):
    ...
    # Build the .h file
    with open(header_file,'w') as hf:
        hf.write(f'// {SERVOMOTOR_H_BASENAME}\n')
        hf.write(f'// This file was autogenerated by generate_command_code.py on {now}\n')
        hf.write('// Do not edit manually. If changes are needed, modify the generator program instead.\n\n')
    ...
    with open(source_file,'w') as sf:
        sf.write(f'// {SERVOMOTOR_CPP_BASENAME}\n')
        sf.write(f'// Autogenerated by generate_command_code.py on {now}\n')
        sf.write('// Do not edit manually. If changes are needed, modify the generator program instead.\n\n')
        sf.write(f'#include "{SERVOMOTOR_H_BASENAME}"\n')
