...
command_id = motor_commands.get_command_id(command_text)
assert(command_id != None)
gathered_inputs = motor_commands.gather_inputs(command_id, [])
response = motor_commands.send_command(command_id, gathered_inputs)
motor_commands.interpret_response(command_id, response)
...
for j in range(2):
    ...
    for i in range(5):
        ...
        command_id = motor_commands.get_command_id(command_text)
        assert(command_id != None)
        gathered_inputs = motor_commands.gather_inputs(command_id, [int(645000 / 20), int(32250 / 2)])
        response = motor_commands.send_command(command_id, gathered_inputs)
        motor_commands.interpret_response(command_id, response)
        time.sleep(0.6)
        ...
        command_id = motor_commands.get_command_id(command_text)
        assert(command_id != None)
        gathered_inputs = motor_commands.gather_inputs(command_id, [1]) # reset the statistics
        response = motor_commands.send_command(command_id, gathered_inputs)
        motor_commands.interpret_response(command_id, response)
        time.sleep(3)
