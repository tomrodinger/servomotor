...
data_type_dict, command_dict = command_loader.load_data_types_and_commands(str(data_types_path), str(motor_commands_path), verbose=False)

# Import M3 class and define commands
from .M3 import M3, define_commands
define_commands(M3, data_type_dict, command_dict, verbose=False)
