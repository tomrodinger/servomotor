...
import servomotor
import math
from glue_machine_calibration import get_affine_transformation_matrix
...
TRANSFORMATION_MATRIX_FILE = "glue_machine_transformation_matrix.json"
...
def main():
    ...
    try:
        ...
        with open(TRANSFORMATION_MATRIX_FILE, 'w') as f:
