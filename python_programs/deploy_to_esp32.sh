...
# Deployment script for uploading servomotor library to ESP32-S3
# Usage: ./deploy_to_esp32.sh [serial_port]

# Default port for ESP32-S3
PORT="${1:-/dev/cu.usbmodem2101}"

echo "========================================="
echo "Deploying Servomotor Library to ESP32-S3"
echo "========================================="
echo "Port: $PORT"
echo ""
...
echo "Step 1: Checking ESP32-S3 connection..."
if ! mpremote connect $PORT exec "print('Connected')"; then
    echo "ERROR: Cannot connect to ESP32-S3 at $PORT"
    exit 1
fi
echo "✓ Connection successful"
echo ""

echo "Step 2: Creating servomotor directory on ESP32-S3..."
