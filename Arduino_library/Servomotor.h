...
typedef struct __attribute__((__packed__)) {
    ...
    VersionNumber24 hardwareVersion;
...
typedef struct __attribute__((__packed__)) {
    VersionNumber32 firmwareVersion;
...
public:
    ...
    void captureHallSensorData(uint8_t captureType, uint32_t nPointsToRead, uint8_t channelsToCaptureBitmask, uint16_t timeStepsPerSample, uint16_t nSamplesToSum, uint16_t divisionFactor, uint8_t* buffer, uint16_t bufferSize, uint16_t* actualSize);
    void captureHallSensorData(uint64_t uniqueId, uint8_t captureType, uint32_t nPointsToRead, uint8_t channelsToCaptureBitmask, uint16_t timeStepsPerSample, uint16_t nSamplesToSum, uint16_t divisionFactor, uint8_t* buffer, uint16_t bufferSize, uint16_t* actualSize);
    ...
    timeSyncResponse timeSyncRaw(uint32_t masterTime);
    timeSyncResponse timeSync(float masterTime);
    timeSyncResponse timeSync(uint64_t uniqueId, float masterTime);
    timeSyncResponse timeSyncRaw(uint64_t uniqueId, uint32_t masterTime);
    ...
    void getProductDescription(char* buffer, uint16_t bufferSize, uint16_t* actualSize);
    void getProductDescription(uint64_t uniqueId, char* buffer, uint16_t bufferSize, uint16_t* actualSize);
    ...
    void readMultipurposeBuffer(uint64_t uniqueId, uint8_t* buffer, uint16_t bufferSize, uint16_t* actualSize);
