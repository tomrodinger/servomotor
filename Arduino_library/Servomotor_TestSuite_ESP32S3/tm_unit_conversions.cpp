...
static float convertTimeBetweenUnits(float value, TimeUnit fromUnit, TimeUnit toUnit) {
...
static float convertPositionBetweenUnits(float value, PositionUnit fromUnit, PositionUnit toUnit) {
...
static float convertVelocityBetweenUnits(float value, VelocityUnit fromUnit, VelocityUnit toUnit) {
...
static float convertAccelerationBetweenUnits(float value, AccelerationUnit fromUnit, AccelerationUnit toUnit) {
...
static float convertCurrentBetweenUnits(float value, CurrentUnit fromUnit, CurrentUnit toUnit) {
...
static float convertVoltageBetweenUnits(float value, VoltageUnit fromUnit, VoltageUnit toUnit) {
...
static float convertTemperatureBetweenUnits(float value, TemperatureUnit fromUnit, TemperatureUnit toUnit) {
...
static void testConversion(const char* testName, float actual, float expected, float tolerance=0.001f) {
    bool result = approxEqual(actual, expected, tolerance);
    TEST_RESULT(testName, result);
}

void tm_unit_conversions(void) {
    // No motor needed: pure unit-conversion computation.
