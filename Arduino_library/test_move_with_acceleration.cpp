...
void setup() {
    ...
    // Move with acceleration (2 * COUNTS_PER_REVOLUTION counts per second squared for 1 second)
    // 2 * COUNTS_PER_REVOLUTION counts = 2 rotations
    const float accel_test3 = 2.0f * COUNTS_PER_REVOLUTION;  // counts per second squared
    ...
    // Calculation: 2.0 rot/sec² * COUNTS_PER_REVOLUTION counts/rot = 2.0 * COUNTS_PER_REVOLUTION counts/sec²
