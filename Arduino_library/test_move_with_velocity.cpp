...
void setup() {
    ...
    // Move with velocity (2 * COUNTS_PER_REVOLUTION counts per second for 1 second = 2 rotations)
    ...
    // Test 4: 2 rotations
    // Total: 8 rotations * COUNTS_PER_REVOLUTION counts/rotation = 8 * COUNTS_PER_REVOLUTION counts
    const int64_t ONE_ROTATION_COUNTS = COUNTS_PER_REVOLUTION;
