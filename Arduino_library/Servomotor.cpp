...
float Servomotor::getCurrentTime() {
    ...
    float convertedResult = convertTime((float)rawResult.currentTime, m_timeUnit, ConversionDirection::FROM_INTERNAL);
...
float Servomotor::getHallSensorPosition() {
    ...
    float convertedResult = convertPosition((float)rawResult.hallSensorPosition, m_positionUnit, ConversionDirection::FROM_INTERNAL);
    return convertedResult;
}
...
float Servomotor::getSupplyVoltage() {
    ...
    float convertedResult = convertVoltage((float)rawResult.supplyVoltage, m_voltageUnit, ConversionDirection::FROM_INTERNAL);
    return convertedResult;
}
...
float Servomotor::getTemperature() {
    ...
    float convertedResult = convertTemperature((float)rawResult.temperature, m_temperatureUnit, ConversionDirection::FROM_INTERNAL);
    return convertedResult;
}
