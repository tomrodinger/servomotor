// Servomotor.cpp
// This file was autogenerated by generate_command_code_new2.py on Dec 28 2025 09:33:52
...
timeSyncResponse Servomotor::timeSync(float masterTime) {
    ...
    timeSyncRaw((uint32_t)(masterTime_internal));
}
...
timeSyncResponse Servomotor::timeSync(uint64_t uniqueId, float masterTime) {
    ...
    Serial.print("  masterTime in chosen unit: "); Serial.println(masterTime);
    float masterTime_internal = ::convertTime(masterTime, m_timeUnit, ConversionDirection::TO_INTERNAL);
    timeSyncRaw(uniqueId, (uint32_t)(masterTime_internal));
}
