...
ServoMotor::ServoMotor(uint8_t alias, HardwareSerial& serialPort)
    : _alias(alias), _comm(serialPort), _errno(0),
      ...
      m_currentUnit(CurrentUnit::ARBITRARY_UNITS),
...
void ServoMotor::setCurrentUnit(CurrentUnit unit) {
    ...
    switch(unit) {
        case CurrentUnit::ARBITRARY_UNITS: Serial.println("ARBITRARY_UNITS"); break;
...
void ServoMotor::setMaximumVelocity(float maximumVelocity) {
    ...
    float maximumVelocity_internal = convertVelocity(maximumVelocity, m_velocityUnit, VelocityUnit::COUNTS_PER_TIMESTEP);
...
void ServoMotor::setMaximumAcceleration(float maximumAcceleration) {
    ...
    float maximumAcceleration_internal = convertAcceleration(maximumAcceleration, m_accelerationUnit, AccelerationUnit::COUNTS_PER_TIMESTEP_SQUARED);
...
void ServoMotor::moveWithAcceleration(float acceleration, float timeSteps) {
    ...
    float acceleration_internal = convertAcceleration(acceleration, m_accelerationUnit, AccelerationUnit::COUNTS_PER_TIMESTEP_SQUARED);
...
void ServoMotor::moveWithVelocity(float velocity, float duration) {
    ...
    float velocity_internal = convertVelocity(velocity, m_velocityUnit, VelocityUnit::COUNTS_PER_TIMESTEP);
    float duration_internal = convertTime(duration, m_timeUnit, TimeUnit::TIMESTEPS);
...
void ServoMotor::setMaximumMotorCurrent(float motorCurrent, float regenerationCurrent) {
    ...
    float motorCurrent_internal = convertCurrent(motorCurrent, m_currentUnit, CurrentUnit::ARBITRARY_UNITS);
    float regenerationCurrent_internal = convertCurrent(regenerationCurrent, m_currentUnit, CurrentUnit::ARBITRARY_UNITS);
...
float ServoMotor::getTemperature() {
    ...
    float convertedResult = convertTemperature((float)rawResult.temperature, TemperatureUnit::CELSIUS, m_temperatureUnit);
    return convertedResult;
}
