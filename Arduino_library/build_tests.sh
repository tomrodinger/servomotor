...
COMMON_SOURCES="ArduinoEmulator.cpp ServomotorCommands.cpp Communication.cpp Utils.cpp DataTypes.cpp AutoGeneratedUnitConversions.cpp test_framework.cpp"
