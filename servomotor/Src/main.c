...
#define DEVELOPMENT_FIRMWARE_VERSION 4 // this is the least significant number when it comes to versioning and is the last number on the right when printed in human readable form
