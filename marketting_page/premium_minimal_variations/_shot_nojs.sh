...
#
# --force-prefers-reduced-motion --disable-javascript matters too: pages using IntersectionObserver scroll-reveal
...
run_chrome() {  # run_chrome <url> <out> <w> <h>
  ...
  "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome" \
    ...
    --force-prefers-reduced-motion --disable-javascript --force-device-scale-factor=1 \
