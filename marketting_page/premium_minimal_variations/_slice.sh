#!/bin/bash
# Usage: ./_slice.sh <page-relative-url> <out.png> <layoutWidth> <sliceTop> <sliceHeight>
set -u
URL="$1"; OUT="$2"; W="$3"; TOP="$4"; SH="$5"
...
iframe{position:absolute;left:0;top:-${TOP}px;width:${W}px;height:26000px;border:0;display:block}</style>
<div id="c"><iframe src="${URL}" scrolling="no"></iframe></div>
EOF2
